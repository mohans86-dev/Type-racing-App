...
import 'package:typeracer_app/widgets/custom_button.dart';
    ...
    return SafeArea(
      child: Padding(
        padding: const EdgeInsets.all(
          16.0,
        ), // Adds space from edges and system UI
        child:
            playerMe['isPartyLeader'] && isBtn
                ? CustomButton(
                  text: 'START',
                ...
                : TextFormField(
                  ...
                  onChanged:
                      (val) => handleTextChange(val, gameData.gameState['id']),
